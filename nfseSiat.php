...
$nfse = [
  ...
  "servico" => [
    ...
    "codigoMunicipio"       => "1501402", //código do município onde ocorreu o fato gerador do serviço (geralmente o mesmo do prestador do serviço)
    "municipioIncidencia"   => "1501402",
